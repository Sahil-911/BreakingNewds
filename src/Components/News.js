...
export class News extends Component {
    ...
    async componentDidMount() {
        ...
        let url = 'https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=aacce8652f284af49a70dcfd2d7fefc8';
